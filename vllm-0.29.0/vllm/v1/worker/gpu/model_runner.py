...
class GPUModelRunner(LoRAModelRunnerMixin):
    ...
    def set_sparse_kernel(self, kernel) -> None:
        """Register a sparse attention kernel for Phase 2 (decode).
        
        The kernel must have a `run` method compatible with the sparse attention
        interface (e.g., skylight_kernels.sparse_oracle_topk_optimized
        .BatchDecodeWithPagedKVCacheWrapper).
        """
        self._sparse_kernel = kernel
    ...
    def execute_model(
        ...
        if batch_req_state is not None:
            ...
            if not dummy_run:
                ...
                if decode_req_ids:
                    num_scheduled_tokens_by_request = {
