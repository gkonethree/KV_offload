...
def ensure_benchmarks_loaded() -> None:
    """Import the vendored benchmark subpackages so their @register_benchmark
    decorators populate the registry (replaces the hub top-level auto-import)."""
    from . import longbench, longbenchv2, ruler, infinite_bench, loogle  # noqa: F401
